...
while True:
    ...
    # Show the content of the sentence
    sentence_text = " ".join(sentence)
    cv2.putText(imgOutput, f"Sentence: {sentence_text}", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 2)

    # Speak the sentence when 's' is pressed
